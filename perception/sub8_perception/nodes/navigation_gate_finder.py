...
class NavigationGateFinder():
	...
	def _img_callback_a(self, img):
		...
		# self.vis = n1p.concatenate((image, img), axis=1)
		# self.image_pub.publish(self.vis)
		# cv2.imshow("debug", img)
		cv2.waitKey(30)

if __name__ == '__main__':
    rospy.init_node('navigation_gate_finder')
    NavigationGateFinder()
    rospy.spin()
